...
package com.k2.mobile.app.view.wheel;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF00925F;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFCECECE;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111, 0x00E8E2E2, 0x00E8E2E2 };
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(TEXT_SIZE + 15);
