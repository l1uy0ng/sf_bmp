 ...
 * @version V1.0
 */
public class LConsultationAdapter extends BaseAdapter {
	
	private Context mContext;
	private List<PopularContentBean> hList;
    
	public LConsultationAdapter(Context mContext, List<PopularContentBean> hList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_lc_menu_add, null);
			...
			item_ico.setImageResource(R.drawable.certification);
			
			PopularContentBean bean = hList.get(position);
			item_name.setText(bean.getPopularTitle());
