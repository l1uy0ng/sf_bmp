...
public class PublicBean {
	...
	private String listType;		// 请求类型 1，报修人   2，维修人
	private String repairCode;		// 报修的CODE
	...
	private String assessmentContent;	// 评价意见
 	private String problemIsSolved;		// 是否解决
	...
	public String getSourceMailCode() {
		return sourceMailCode;
	}
	public void setSourceMailCode(String sourceMailCode) {
		this.sourceMailCode = sourceMailCode;
	}
