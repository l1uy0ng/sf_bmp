 ...
 * 
 * @author linqijun	
 * @date 2015-06-06 8:28:00
 * @version V1.0
 */
public class SearchEmailActivity extends BaseActivity implements OnClickListener {
		...
		public void dispatchMessage(Message msg) {
			switch (msg.what) {
				case 1:
					...
					eList.clear();
					eList.addAll(JSON.parseArray(json, EmailBean.class));
	...
	RequestCallBack<String> submitCallBack = new RequestCallBack<String>() {
		...
		@Override
		public void onStart() {
			DialogUtil.showWithCancelProgressDialog(SearchEmailActivity.this, null, res.getString(R.string.global_prompt_message), null);
		}
		...
		public void onSuccess(ResponseInfo<String> responseInfo) {                                     
			...
			if (null != result && !"".equals(result.trim())) {
				...
				if (null == msg || null == msg.getResCode() || "".equals(msg.getResCode())) {				
					LogUtil.promptInfo(SearchEmailActivity.this, ErrorCodeContrast.getErrorCode("0", res));
					return;
				// 验证不合法
				}else if ("1103".equals(msg.getResCode()) || "1104".equals(msg.getResCode())) {
					LogUtil.promptInfo(SearchEmailActivity.this, ErrorCodeContrast.getErrorCode(msg.getResCode(), res));	
				...
				if (null == msg.getMessage() || "".equals(msg.getMessage().trim())) {		 
					DialogUtil.showLongToast(SearchEmailActivity.this, R.string.global_no_data);
				} else {
					// 获取解密后并校验后的值
		...
		public void onFailure(HttpException error, String msg) {
			...
			if(null != msg && msg.equals(LocalConstants.API_KEY)){
				LogUtil.promptInfo(SearchEmailActivity.this, ErrorCodeContrast.getErrorCode("1207", res));
			}else{
				LogUtil.promptInfo(SearchEmailActivity.this, ErrorCodeContrast.getErrorCode("0", res));
			}
		}
