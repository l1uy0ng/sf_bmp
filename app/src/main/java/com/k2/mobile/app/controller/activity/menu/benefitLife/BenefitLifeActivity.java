...
*/
@SuppressLint("NewApi")
public class BenefitLifeActivity extends BaseActivity implements OnClickListener, OnItemClickListener {
...
//		}
	...
	RequestCallBack<String> submitCallBack = new RequestCallBack<String>() {
		...
		@Override
		public void onStart() {
			DialogUtil.showWithCancelProgressDialog(BenefitLifeActivity.this, null, getResources().getString(R.string.global_prompt_message), null);
		}
		...
		public void onSuccess(ResponseInfo<String> responseInfo) {                                     
			...
			if (null != result && !"".equals(result.trim())) {
				...
				if (null == msgs || null == msgs.getResCode() || "".equals(msgs.getResCode())) {				
					LogUtil.promptInfo(BenefitLifeActivity.this, ErrorCodeContrast.getErrorCode("0", getResources()));
					return;
				}else if ("1103".equals(msgs.getResCode()) || "1104".equals(msgs.getResCode())) {
					LogUtil.promptInfo(BenefitLifeActivity.this, ErrorCodeContrast.getErrorCode(msgs.getResCode(), getResources()));
		...
		public void onFailure(HttpException error, String msg) {
			...
			if(null != msg && msg.equals(LocalConstants.API_KEY)){
				LogUtil.promptInfo(BenefitLifeActivity.this, ErrorCodeContrast.getErrorCode("1207", getResources()));
			}else{
				LogUtil.promptInfo(BenefitLifeActivity.this, ErrorCodeContrast.getErrorCode("0", getResources()));
			}
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if(0 < type){
			mIntent = new Intent(BenefitLifeActivity.this, StaticLinkListActivity.class);
