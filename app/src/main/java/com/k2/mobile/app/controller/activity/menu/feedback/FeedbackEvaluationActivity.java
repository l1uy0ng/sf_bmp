 ...
 * 
 */
public class FeedbackEvaluationActivity extends FragmentActivity implements OnClickListener {
				...
				case 1:
					...
					if (null != resSave) {
						...
						if (null != bean && "1".equals(bean.getSuccess())) {
							DialogUtil.showLongToast(FeedbackEvaluationActivity.this, R.string.evaluation_success);
							Intent mIntent = new Intent(BroadcastNotice.FEEDBACK_FINISH_UPDATE);
							sendBroadcast(mIntent);
							setResult(RESULT_OK);  
							finish();
						} else {
							DialogUtil.showLongToast(FeedbackEvaluationActivity.this, R.string.evaluation_failed);
						}
					}
					break;
			}
	...
	*/
	private void requestServer(int server, String info) {
		// 判断网络是否连接
		if (!NetWorkUtil.isNetworkAvailable(FeedbackEvaluationActivity.this)) {
			DialogUtil.showLongToast(FeedbackEvaluationActivity.this, R.string.global_network_disconnected);
		}else{
			SendRequest.sendSubmitRequest(FeedbackEvaluationActivity.this, info, BaseApp.token, BaseApp.reqLang, server, BaseApp.key, submitCallBack);
		}
	}
	...
	RequestCallBack<String> submitCallBack = new RequestCallBack<String>() {
		...
		@Override
		public void onStart() {
			DialogUtil.showWithCancelProgressDialog(FeedbackEvaluationActivity.this, null, getResources().getString(R.string.global_prompt_message), null);
		}
		...
		public void onSuccess(ResponseInfo<String> responseInfo) {     
			...
			if (null != result && !"".equals(result.trim())) {
				...
				if (null == msg || null == msg.getResCode() || "".equals(msg.getResCode())) {				
					LogUtil.promptInfo(FeedbackEvaluationActivity.this, ErrorCodeContrast.getErrorCode("0", getResources()));
					return;
				// 验证不合法
				}else if ("1103".equals(msg.getResCode()) || "1104".equals(msg.getResCode())) {
					LogUtil.promptInfo(FeedbackEvaluationActivity.this, ErrorCodeContrast.getErrorCode(msg.getResCode(), getResources()));
					Intent mIntent = new Intent(BroadcastNotice.USER_EXIT);
					FeedbackEvaluationActivity.this.sendBroadcast(mIntent);
					return;
		...
		public void onFailure(HttpException error, String msg) {
			...
			if(null != msg && msg.equals(LocalConstants.API_KEY)){
				LogUtil.promptInfo(FeedbackEvaluationActivity.this, ErrorCodeContrast.getErrorCode("1207", getResources()));
			}else{
				LogUtil.promptInfo(FeedbackEvaluationActivity.this, ErrorCodeContrast.getErrorCode("0", getResources()));
			}
		}
