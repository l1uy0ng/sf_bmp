...
public class RefreshScrollView extends ScrollView {
	...
	private final static String TAG = "RefreshScrollView";
...
//					}
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (!isRecored && getScrollY() == 0) { // 在move时候记录下位置
					isRecored = true;
					startY = tempY;
				}
...
//							Log.i(TAG, "由DOne或者下拉刷新状态转变到done状态");
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_To_REFRESH:
			...
			tipsTextview.setText(context.getString(R.string.xlistview_header_hint_ready));
...
//			Log.i(TAG, "当前状态，松开刷新");
		...
		case PULL_To_REFRESH:
			...
			if (isBack) {
				...
				tipsTextview.setText(context.getString(R.string.xlistview_header_hint_normal));
			} else {
				tipsTextview.setText(context.getString(R.string.xlistview_header_hint_normal));
			}
//			Log.i(TAG, "当前状态，下拉刷新");
		...
		case REFRESHING:
			...
			tipsTextview.setText(context.getString(R.string.refreshing));
			lastUpdatedTextView.setVisibility(View.VISIBLE);
...
//			Log.i(TAG, "当前状态，done");
	...
	public void onRefreshComplete() {
		state = DONE;
		lastUpdatedTextView.setText(context.getString(R.string.xlistview_header_last_time) + new Date().toLocaleString());
		changeHeaderViewByState();
		invalidate();
		scrollTo(0, 0);
	}
