...
import com.k2.mobile.app.controller.activity.menu.feedback.PickPhotoActivity;
import com.k2.mobile.app.model.album.BitmapCache.ImageCallback;
import com.k2.mobile.app.utils.LogUtil;
/**
 * @ClassName: ImageGridAdapter
 * @Description: 相册gridview视图适配器
 * @author force
 * @date 2015年8月3日 上午8:45:21
 *
 */
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            if (null == convertView) {
                holder = new Holder();
                convertView = View.inflate(activity, R.layout.tt_item_image_grid,null);
            ...
            holder.iv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (null != bmp && bmp == PickPhotoActivity.bimap) {
                        Toast.makeText(
                                activity,
                                activity.getResources().getString(R.string.unavailable_image_file),
                                Toast.LENGTH_LONG).show();
                        return;
                    }
                    if (selectTotal < maxCount) {
