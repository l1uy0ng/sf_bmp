...
import com.k2.mobile.app.model.adapter.AssignedMeAdapter;
...
*/
@SuppressLint("NewApi")
public class AssignedToMeFragment extends Fragment implements IXListViewListener, OnClickListener{
	...
	private void initAdapter() {
		mAdapter = new AssignedMeAdapter(getActivity(), tList, taskType);
	...
	*/
	public void requestServer() {
		...
		if (!NetWorkUtil.isNetworkAvailable(getActivity())) {
			...
			String info = getAcceptInfo(4);
			switch (operClass) {
			case 1:
				info = getAcceptInfo(4);
				taskType = 0;
				break;
			case 2:
				info = getAcceptInfo(5);
				taskType = 1;
				break;
			case 3:
				info = getAcceptInfo(6);
				taskType = 2;
				break;
			}
	...
	*/
	...
	private void createFilter() {
		...
		filter.addAction(BroadcastNotice.TASKS_UI_UPDATE);
		filter.addAction(BroadcastNotice.TASKS_UNFINISH_UPDATE);
		filter.addAction(BroadcastNotice.TASKS_FINISH_UPDATE);
	...
	private class IncomingReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
	        ...
	        if (action.equals(BroadcastNotice.TASKS_UI_UPDATE)) {
	        	operClass = 1;
	        	requestServer();
	        } else if (action.equals(BroadcastNotice.TASKS_UNFINISH_UPDATE)) {
//	        	flag = 1;
	        	operClass = 2;
	        	requestServer();
	        } else if (action.equals(BroadcastNotice.TASKS_FINISH_UPDATE)) {
//	        	flag = 1;
	        	operClass = 3;
	        	requestServer();
	        }
