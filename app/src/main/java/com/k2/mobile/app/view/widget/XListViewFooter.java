...
//		mHintView.setTextSize(DensityUtil.px2dip(mContext, 36));
		val = context.getString(R.string.xlistview_footer_hint_normal);
	}
	// 修改XListView底部提示
	public void setTips(String tips){
		val = tips;
		mHintView.setText(tips);// 查看更多
	}
}
